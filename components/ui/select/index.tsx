...
const selectTriggerStyle = tva({
  base: "text-[#2EC4B6] border border-[#2EC4B6]  rounded flex-row items-center overflow-hidden data-[hover=true]:border-[#10524B] data-[focus=true]:border-[#2EC4B6] data-[focus=true]:hover:border-[#2EC4B6] data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-[#10524B]",
  variants: {
    size: {
      xl: "h-12",
      lg: "h-11",
    ...
    variant: {
      underlined:
        "border-0 border-b rounded-none data-[hover=true]:border-primary-700 data-[focus=true]:border-primary-700 data-[focus=true]:web:shadow-[inset_0_-1px_0_0] data-[focus=true]:web:shadow-primary-700 data-[invalid=true]:border-[#9A0000] data-[invalid=true]:web:shadow-error-700",
      outline:
      ...
      rounded:
        "rounded-[14px] data-[focus=true]:border-primary-700 data-[focus=true]:web:shadow-[inset_0_0_0_1px] data-[focus=true]:web:shadow-primary-700 data-[invalid=true]:border-[#9A0000] data-[invalid=true]:web:shadow-error-700",
    },
  },
});
